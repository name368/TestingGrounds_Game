...
UInputComponent* PlayerInputComponentBeginPlay;
...
void AS05_TestingGroundsCharacter::BeginPlay()
{
	...
	{ 
		UE_LOG(LogTemp, Warning, TEXT("GunBlueprint missing in S05_TestingGroundsCharacter"));
		return; 
	}
	...
	if (EnableTouchscreenMovement(PlayerInputComponentBeginPlay) == false)
	{
		PlayerInputComponentBeginPlay->BindAction("Fire", IE_Pressed, Gun, &AGun::OnFire);
	}
}
...
void AS05_TestingGroundsCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponentBeginPlay = PlayerInputComponent;
